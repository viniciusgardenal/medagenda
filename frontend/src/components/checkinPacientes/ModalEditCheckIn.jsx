  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white w-full max-w-2xl p-6 rounded-2xl shadow-md">
        ...
        <h3 className="text-2xl font-bold text-blue-600 mb-6">Editar Check-In</h3>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              type="text"
              value={new Date(checkIn.horaChegada).toLocaleString()}
              disabled
              className="w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-md text-gray-700 text-sm"
            />
          </div>
...
export default ModalEditCheckIn;