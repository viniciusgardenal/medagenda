    ...
    <table className="medicamentos-table">
      <thead>
        <tr>
          ...
          <th>Interações Medicamentosas</th> */}
          <th>Ações</th>
        </tr>
      </thead>
      <tbody>
        {medicamentos.map((medicamento) => (
          <tr key={medicamento.idMedicamento}>
            ...
            <td>
              <button onClick={() => onDetalhes(medicamento.idMedicamento)}>
                <svg
              ...
              <button onClick={() => onEditar(medicamento.idMedicamento)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <button onClick={() => onExcluir(medicamento.idMedicamento)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
