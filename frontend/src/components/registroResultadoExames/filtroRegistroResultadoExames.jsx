...
const FiltroRegistroResultadoExames = ({ onFiltroChange }) => {
    ...
    const [filtroNomeExame, setFiltroNomeExame] = React.useState('');

    // Atualiza o filtro no componente pai sempre que um dos campos muda
    React.useEffect(() => {
        onFiltroChange({ filtroId, filtroNome, filtroNomeExame });
    }, [filtroId, filtroNome, filtroNomeExame, onFiltroChange]);

    return (
        <div className="space-y-1 mb-6">
            <label className="text-sm font-medium text-gray-600 block">
                Buscar por ID, profissional, paciente ou nome do exame
            </label>
            <div className="flex flex-col md:flex-row gap-4 items-stretch">
                ...
                <div className="relative w-full">
                    ...
                    <input
                        ...
                        placeholder="Nome do profissional, paciente"
                        className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-700 text-sm"
                    />
                </div>
                <div className="relative w-full">
                    ...
                    <input
                        type="text"
                        value={filtroNomeExame}
                        onChange={(e) => setFiltroNomeExame(e.target.value)}
