    ...
    return (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-10">
            <div className="relative bg-white w-full max-w-2xl p-8 rounded-2xl shadow-lg">
                ...
                <h2 className="text-2xl font-bold text-blue-600 mb-6">Definir Resultado</h2>
                <div className="space-y-6">
                    <div>
                        <label className="block text-sm font-medium text-gray-600 mb-1">Definir Observações:</label>
                        <textarea
