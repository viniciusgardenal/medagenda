    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-4 max-w-2xl w-full border border-gray-200 shadow-sm">
        <div className="flex justify-between items-center mb-2">
          <h2 className="text-lg font-semibold text-blue-700">Detalhes do Tipo de Exame</h2>
        ...
        {tipoExame ? (
          <div className="bg-gray-50 p-4 rounded-md border border-gray-200 space-y-2 text-gray-800">
            <div className="flex items-center py-1 border-b border-gray-200">
              ...
              <p className="text-base ml-1">{tipoExame.idTipoExame}</p>
            </div>
            <div className="flex items-center py-1 border-b border-gray-200">
              <p className="text-sm font-semibold">Nome do Exame:</p>
              <p className="text-base ml-1">{tipoExame.nomeTipoExame}</p>
            </div>
            <div className="flex items-center py-1 border-b border-gray-200">
              <p className="text-sm font-semibold">Material Coletado:</p>
              <p className="text-base ml-1">{tipoExame.materialColetado}</p>
            </div>
            <div className="flex items-center py-1 border-b border-gray-200">
              <p className="text-sm font-semibold">Tempo em Jejum (Horas):</p>
              <p className="text-base ml-1">{tipoExame.tempoJejum}</p>
            </div>
            <div className="flex items-center py-1 border-b border-gray-200">
              <p className="text-sm font-semibold">Categoria:</p>
              <p className="text-base ml-1">{tipoExame.categoria}</p>
            </div>
            <div className="flex items-center py-1 border-b border-gray-200">
              <p className="text-sm font-semibold">Observação:</p>
              <p className="text-base ml-1">{tipoExame.observacao}</p>
            </div>
          </div>
        ) : (
