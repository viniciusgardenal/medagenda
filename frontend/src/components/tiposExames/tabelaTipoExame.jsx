        ...
        {tiposExames.length === 0 ? (
          ...
          tiposExames.map((tipoExame) => (
            <tr key={tipoExame.idTipoExame} className="hover:bg-blue-50 transition-colors">
              <td className="px-6 py-4 text-sm text-gray-700">{tipoExame.nomeTipoExame}</td>
              <td className="px-6 py-4 text-sm text-gray-700">{tipoExame.materialColetado}</td>
              <td className="px-6 py-4 text-sm text-gray-700">{tipoExame.categoria}</td>
